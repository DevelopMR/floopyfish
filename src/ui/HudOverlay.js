...
export class HudOverlay {
  ...
  draw() {
    ...
    const fittestY = y + 116 * this.panelScale;
    ...
    const cardGap = l.cardGap * this.panelScale;
    const leftCardWidth = 140 * this.panelScale;
    const rightCardWidth = 170 * this.panelScale;
    ...
    this.loopValue.x = loopCard.x + 98 * this.panelScale;
